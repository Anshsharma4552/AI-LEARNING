      ...
      <div className="relative max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-5">
              {stats.map((stat, index) => (
                  <div
                      key={index}
                      className="group relative bg-white/80 backdrop-blur-xl border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6 hover:2xl hover:shadow-slate-300/50 transition-all duration-300 hover:-translate-y-1"
                  >
            ...
            <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl drop-shadow-slate-200/50 p-8'>
                          ...
                          >
                            <div className='flex-1 min-w-0'>
                              <div className='flex items-center gap-2 mb-1'>
                                ...
                                {activity.type==="document" ? 'Accessed Document' : "Attempted Quizz"}
